...
function Swipe(n, t) {
	...
	function d() {
		var s, h;
		for (f = u.children, tt = f.length, f.length < 2 && (t.continuous = !1), a.transitions && t.continuous && f.length < 3 && (u.appendChild(f[0].cloneNode(!0)), u.appendChild(u.children[1].cloneNode(!0)), f = u.children), l = new Array(f.length), r = n.getBoundingClientRect().width || n.offsetWidth, u.style.width = f.length * r + "px", s = f.length; s--;) h = f[s], h.style.width = r + "px", h.setAttribute("data-index", s), a.transitions && (h.style.left = s * -r + "px", o(s, i > s ? -r : i < s ? r : 0, 0));
		t.continuous && a.transitions && (o(e(i - 1), -r, 0), o(e(i + 1), r, 0)), a.transitions || (u.style.left = i * -r + "px"), n.style.visibility = "visible"
	}

	function ft() {
		t.continuous ? w(i - 1) : i && w(i - 1)
	}

	function it() {
		t.continuous ? w(i + 1) : i < f.length - 1 && w(i + 1)
	}
	...
	function w(n, u) {
		...
		if (i != n) {
			if (a.transitions) {
				...
				n = e(n), o(i, r * s, u || c), o(n, 0, u || c), t.continuous && o(e(n - s), -(r * s), 0)
			} else n = e(n), et(i * -r, n * -r, u || c);
			i = n, k(t.callback && t.callback(i, f[i]))
		}
	}
	...
	function et(n, r, e) {
		...
		var o = +new Date,
			s = setInterval(function () {
				var h = +new Date - o;
				if (h > e) {
					u.style.left = r + "px", y && nt(), t.transitionEnd && t.transitionEnd.call(event, i, f[i]), clearInterval(s);
					return
				}
	...
	var ut = function () {},
		...
		u, f, l, r, tt, i, c, y, rt;
	if (n) {
		u = n.children[0], t = t || {}, i = parseInt(t.startSlide, 10) || 0, c = t.speed || 300, t.continuous = t.continuous !== undefined ? t.continuous : !0, y = t.auto || 0;
		var g = {},
			s = {},
			p, h = {
				...
				start: function (n) {
					...
					g = {
						...
						y: t.pageY,
						time: +new Date
					}, p = undefined, s = {}, u.addEventListener("touchmove", this, !1), u.addEventListener("touchend", this, !1)
				},
				move: function (n) {
					if (!(n.touches.length > 1) && (!n.scale || n.scale === 1)) {
						...
						s = {
							x: u.pageX - g.x,
							y: u.pageY - g.y
						}, typeof p == "undefined" && (p = !!(p || Math.abs(s.x) < Math.abs(s.y))), p || (n.preventDefault(), b(), t.continuous ? (v(e(i - 1), s.x + l[e(i - 1)], 0), v(i, s.x + l[i], 0), v(e(i + 1), s.x + l[e(i + 1)], 0)) : (s.x = s.x / (!i && s.x > 0 || i == f.length - 1 && s.x < 0 ? Math.abs(s.x) / r + 1 : 1), v(i - 1, s.x + l[i - 1], 0), v(i, s.x + l[i], 0), v(i + 1, s.x + l[i + 1], 0)))
					}
				},
				end: function () {
					var v = +new Date - g.time,
						...
						a;
					t.continuous && (n = !1), a = s.x < 0, p || (y && !n ? (a ? (t.continuous ? (o(e(i - 1), -r, 0), o(e(i + 2), r, 0)) : o(i - 1, -r, 0), o(i, l[i] - r, c), o(e(i + 1), l[e(i + 1)] - r, c), i = e(i + 1)) : (t.continuous ? (o(e(i + 1), r, 0), o(e(i - 2), -r, 0)) : o(i + 1, r, 0), o(i, l[i] + r, c), o(e(i - 1), l[e(i - 1)] + r, c), i = e(i - 1)), t.callback && t.callback(i, f[i])) : t.continuous ? (o(e(i - 1), -r, c), o(i, 0, c), o(e(i + 1), r, c)) : (o(i - 1, -r, c), o(i, 0, c), o(i + 1, r, c))), u.removeEventListener("touchmove", h, !1), u.removeEventListener("touchend", h, !1)
				},
				transitionEnd: function (n) {
					parseInt(n.target.getAttribute("data-index"), 10) == i && (y && nt(), t.transitionEnd && t.transitionEnd.call(n, i, f[i]))
				}
			};
		return d(), y && nt(), a.addEventListener ? (a.touch && u.addEventListener("touchstart", h, !1), a.transitions && (u.addEventListener("webkitTransitionEnd", h, !1), u.addEventListener("msTransitionEnd", h, !1), u.addEventListener("oTransitionEnd", h, !1), u.addEventListener("otransitionend", h, !1), u.addEventListener("transitionend", h, !1)), window.addEventListener("resize", h, !1)) : window.onresize = function () {
			d()
		}, {
			setup: function () {
				d()
			...
			kill: function () {
				var n, t;
				for (b(), u.style.width = "auto", u.style.left = 0, n = f.length; n--;) t = f[n], t.style.width = "100%", t.style.left = 0, a.transitions && v(n, 0, 0);
