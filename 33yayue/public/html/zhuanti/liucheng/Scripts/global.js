...
function SearchClick() {
    ...
    window.location = "http://www.0898yue.com/house/?" + url;
}
function goMap() {
    window.open("http://www.0898yue.com/map/", "_blank");
}

//搜索编码
function Yhz_SearchEncode(Yhz_SearchNane, Yhz_SearchText) {
    var Yhz_SearchEncodeText = encodeURIComponent(Yhz_SearchText);
    window.open("http://www.0898yue.com/house/?" + Yhz_SearchNane + "=" + Yhz_SearchEncodeText);
}
