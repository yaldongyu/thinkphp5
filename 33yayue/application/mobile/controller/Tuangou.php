...
class Tuangou extends Frontend
{
    ...
    public function index($typeid=0){
        ...
        $index['list'] = $LptgModel->field('id,KP_Title,KP_PicUrl,KP_Yhxq,KP_EndTime,KP_Yhby,KP_Yhby2')
    ...
    public function detail($ids=''){
            ...
            $index['Lpinfo'] = $LpModel->field('id,KP_LpName,KP_YouHui,KP_City,KP_Citys,KP_Wjt,KP_TaoJia,KP_TsType,KP_Lpdz')->where('id',$index['content']['KP_LpID'])->find();
